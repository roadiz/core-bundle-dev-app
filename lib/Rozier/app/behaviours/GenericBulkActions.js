...
export default function () {
  ...
  const bulkActionsSelectAllButton = document.querySelector('.bulk-layout .uk-button-select-all')
  const bulkActionsFormButtons = document.querySelectorAll('.bulk-layout .uk-button-bulk')
  /**
  ...
  bulkActionsFormButtons.forEach((button) => {
    if (button.hasAttribute('data-bulk-group')) {
      button.addEventListener('click', () => {
        const bulkGroup = document.getElementById(button.getAttribute('data-bulk-group'))
        if (bulkGroup) {
