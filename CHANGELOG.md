...
## [2.5.54](https://github.com/roadiz/core-bundle-dev-app/compare/v2.5.53...v2.5.54) - 2026-09-11

### Bug Fixes

- **(solr)** restore multi-word phrase query ([#476](https://github.com/roadiz/core-bundle-dev-app/issues/476)) - ([f958789](https://github.com/roadiz/core-bundle-dev-app/commit/f958789acdc7d80dbbac34801d1feed9b25ecead))
...
- ensure RealmNode::$node and RealmNode::$realm properties are not null or set - ([37fbaed](https://github.com/roadiz/core-bundle-dev-app/commit/37fbaed4fbabee3ec3714294e3be5af6e8f316f1))
...
- **(walker)** stop recursing into reachable children in AutoChildrenNodeSourceWalker - ([35e2985](https://github.com/roadiz/core-bundle-dev-app/commit/35e2985633bb4aef25c8060b023022d6b5bc74bb))
...
- **(security)** reject unsafe remote URLs in DownloadedFile::fromUrl method - GHSA-rc55-58f4-687g - ([1a710e7](https://github.com/roadiz/core-bundle-dev-app/commit/1a710e7b3134281013f2e85475936683b0c47601))
...
- **(solr)** add fuzzy search configuration options - ([6e74bae](https://github.com/roadiz/core-bundle-dev-app/commit/6e74bae9cd20cdc0140b0ad250934176610cf1d9))

## [2.5.41](https://github.com/roadiz/core-bundle-dev-app/compare/v2.5.40...v2.5.41) - 2025-10-28

### Bug Fixes

- Remove length assertion from folder property - ([1fb5063](https://github.com/roadiz/core-bundle-dev-app/commit/1fb506304efb208d5f2d392308c4c1431ec1f1b8))

## [2.5.40](https://github.com/roadiz/core-bundle-dev-app/compare/v2.5.39...v2.5.40) - 2025-10-23

### Bug Fixes

- **(tags)** add default translation to tag retrieval ([#258](https://github.com/roadiz/core-bundle-dev-app/issues/258)) - ([8290623](https://github.com/roadiz/core-bundle-dev-app/commit/8290623d9eb51f9c93ad693f30145bb8ae8cc527))
...
- **(Document)** Make sanitization optional for Document::setFilename method (default: true) - ([00c37bb](https://github.com/roadiz/core-bundle-dev-app/commit/00c37bb12d11cf15849928b53b2a2c467ff83662))
...
- Update enshrined/svg-sanitize dependency to version ^0.22 - ([9e5bbe4](https://github.com/roadiz/core-bundle-dev-app/commit/9e5bbe478e5d1378a11d1a918544d084ce5f1405))
- Handle sanitization failure in DocumentSvgMessageHandler - ([a567e53](https://github.com/roadiz/core-bundle-dev-app/commit/a567e5360ef3e08edcfd255bc2b39e888ee467cf))
- Exclude SVG documents from DocumentSizeMessageHandler - ([8e86214](https://github.com/roadiz/core-bundle-dev-app/commit/8e86214a9d7edf04c549349da6f6f4bb8dbb12f1))

## [2.5.33](https://github.com/roadiz/core-bundle-dev-app/compare/v2.5.32...v2.5.33) - 2025-09-10

### Bug Fixes

- Add `hl.bs.type` highlighting configuration ([#181](https://github.com/roadiz/core-bundle-dev-app/issues/181)) - ([91bd8a2](https://github.com/roadiz/core-bundle-dev-app/commit/91bd8a24e0c742ea89bddcb7ec78b172cd425f0d))
