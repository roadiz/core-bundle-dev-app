...
class NSMock extends NodesSources
{
     ...
     * @var \RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMockTwo[]|null
            ...
            if (null !== $this->objectManager) {
                $this->fooBarHiddenSources = $this->objectManager
                    ...
                    ->findByNodesSourcesAndFieldNameAndTranslation(
                        $this,
                        'foo_bar_hidden',
                        [\RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMock::class, \RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMockTwo::class]
                    );
            } else {
    ...
    /**
     * @return \RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMockTwo[]
     */
        ...
        if (null === $this->fooBarTypedSources) {
            if (null !== $this->objectManager) {
                $this->fooBarTypedSources = $this->objectManager
                    ->getRepository(\RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMockTwo::class)
                    ->findByNodesSourcesAndFieldNameAndTranslation(
                        $this,
                        'foo_bar_typed',
                        []
    ...
    /**
     * @param \RZ\Roadiz\EntityGenerator\Tests\Mocks\GeneratedNodesSources\NSMockTwo[]|null $fooBarTypedSources
     * @return $this
     */
