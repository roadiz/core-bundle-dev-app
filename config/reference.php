 ...
 *     appNamespace?: scalar|null, // Default: "roadiz_app"
 *     healthCheckToken?: scalar|null, // Default: null
 *     appVersion?: scalar|null, // Default: "0.1.0"
 *     staticDomainName?: scalar|null, // Default: null
 *     maxVersionsShowed?: scalar|null, // Default: 10
 *     helpExternalUrl?: scalar|null, // URL to display help button in back-office. // Default: "https://docs.roadiz.io"
 *     customPublicScheme?: scalar|null, // Replace your public website URL with a dedicated domain name. It can be useful when using *headless* Roadiz version. // Default: null
 *     customPreviewScheme?: scalar|null, // Replace "?_preview=1" query string to preview website content with a dedicated domain name. It can be useful when using *headless* Roadiz version. // Default: null
 *     leafletMapTileUrl?: scalar|null, // Default maps tiles layout when using *Leaflet*. // Default: "https://{s}.tile.osm.org/{z}/{x}/{y}.png"
 *     mapsDefaultLocation?: scalar|null, // Default maps marker location. // Default: "{\"lat\":45.766136, \"lng\":4.837326, \"zoom\":14}"
 *     previewRequiredRoleName?: scalar|null, // Role name required to access preview mode. // Default: "ROLE_BACKEND_USER"
 *     defaultNodeSourceController?: scalar|null, // Default: "RZ\\Roadiz\\CoreBundle\\Controller\\DefaultNodeSourceController"
 *     defaultNodeSourceControllerNamespace?: scalar|null, // Default: "\\App\\Controller"
 *     webResponseClass?: scalar|null, // Default: "RZ\\Roadiz\\CoreBundle\\Api\\Model\\WebResponse"
 *     useNativeJsonColumnType?: bool, // Default: true
 *     useDocumentDto?: bool, // Default: false
 *     hideRoadizVersion?: bool, // Default: false
 *     useGravatar?: bool, // Default: true
 *     useConstraintViolationList?: bool, // Use 422 constraint violation list response for contact-forms and custom-forms errors. Make sure you have exposed "api_custom_forms_item_post" API operation for custom-forms and "api_contact_form_post" API operation for contact-forms. // Default: true
 *     customFormPostOperationName?: scalar|null, // Exposed API operation name for custom-forms POST // Default: "api_custom_forms_item_post"
 *     useEmailReplyTo?: bool, // Use custom-form answers email as reply-to email address when possible. // Default: true
 *     documentsLibDir?: scalar|null, // Relative path to Roadiz Documents lib sources from project directory. // Default: "vendor/roadiz/documents/src"
 *     forceLocale?: bool, // Force displaying translation locale in every generated node-source paths. This should be enabled if you redirect users based on their language on homepage. // Default: false
 *     forceLocaleWithUrlAliases?: bool, // Force displaying translation locale in generated node-source paths even if there is an url-alias in it. // Default: false
 *     useAcceptLanguageHeader?: bool, // When no information to find locale is found and "forceLocale" parameter is ON, we must find translation based on Accept-Language header. Be careful if you are using a reverse-proxy cache, YOU MUST vary on Accept-Language header and normalize it. @see https://varnish-cache.org/docs/6.3/users-guide/increasing-your-hitrate.html#http-vary // Default: false
 *     useTypedNodeNames?: bool, // When enabled, this option will suffix each name for unreachable nodes (blocks) with their node-type to avoid name conflicts with reachable nodes (pages). // Default: true
 *     projectLogoUrl?: scalar|null, // URL to display static project logo in back-office and email templates. // Default: null
 *     generatedClassNamespace?: scalar|null, // Relative path to Roadiz folder for generated entity // Default: "App\\GeneratedEntity"
 *     generatedRepositoryNamespace?: scalar|null, // Relative path to Roadiz folder for generated entity repositories // Default: "App\\GeneratedEntity\\Repository"
 ...
 *             port?: scalar|null, // Default: 8983
 *             path?: scalar|null, // Default: "/"
 *         }>,
 *     },
 *     inheritance?: array{
 *         type?: scalar|null, // Doctrine inheritance strategy for creating NodesSources classes table(s). BE CAREFUL, if you change this setting after filling content in your website, all node-sources data will be lost. // Default: "single_table"
 *     },
 *     reverseProxyCache?: array{
 *         frontend?: array<string, array{ // Default: []
 *             host: scalar|null, // Default: "localhost"
 *             domainName: scalar|null, // Default: "localhost"
 *             timeout?: scalar|null, // Default: 3
 *         }>,
 *         cloudflare?: array{
 *             version?: scalar|null, // Default: "v4"
 *             zone: scalar|null,
 *             bearer?: scalar|null,
 *             email?: scalar|null,
 *             key?: scalar|null,
 ...
 *     },
 *     medias?: array{
 *         unsplash_client_id?: scalar|null, // Default: null
 *         google_server_id?: scalar|null, // Default: null
 *         soundcloud_client_id?: scalar|null, // Default: null
 *         recaptcha_private_key?: scalar|null, // Deprecated: Use roadiz_core.captcha.private_key // Default: null
 *         recaptcha_public_key?: scalar|null, // Deprecated: Use roadiz_core.captcha.public_key // Default: null
 *         recaptcha_verify_url?: scalar|null, // Deprecated: Use roadiz_core.captcha.verify_url // Default: "https://www.google.com/recaptcha/api/siteverify"
 *         ffmpeg_path?: scalar|null, // Default: null
 *     },
 *     captcha?: array{
 *         private_key?: scalar|null, // Default: null
 *         public_key?: scalar|null, // Default: null
 *         verify_url?: scalar|null, // Default: "https://www.google.com/recaptcha/api/siteverify"
 *     },
 * }
 * @psalm-type RoadizRozierConfig = array{
 *     node_form?: scalar|null, // Default: "RZ\\Roadiz\\RozierBundle\\Form\\NodeType"
 *     theme_dir?: scalar|null, // Deprecated: The "theme_dir" configuration option is deprecated and will be removed in 3.0.0. // Relative path to Rozier theme sources from project directory. // Default: "vendor/roadiz/rozier/src"
 *     manifest_path?: scalar|null, // Relative path to Rozier theme manifest.json. // Default: "public/bundles/roadizrozier/manifest.json"
 *     add_node_form?: scalar|null, // Default: "RZ\\Roadiz\\RozierBundle\\Form\\Node\\AddNodeType"
 ...
 *     }>,
 *     open_id?: array{
 *         verify_user_info?: bool, // Verify User info in JWT at each login // Default: true
 *         force_ssl_on_redirect_uri?: bool, // Force generating redirect uri with https scheme. (required by some OpenID providers) // Default: true
 *         discovery_url?: scalar|null, // Standard OpenID autodiscovery URL, required to enable OpenId login in Roadiz CMS. // Default: ""
 *         hosted_domain?: scalar|null, // For public identity providers (such as Google), restrict users emails by their domain. // Default: null
 *         oauth_client_id?: scalar|null, // OpenID identity provider OAuth2 client ID // Default: null
 *         oauth_client_secret?: scalar|null, // OpenID identity provider OAuth2 client secret // Default: null
 *         openid_username_claim?: scalar|null, // OpenID identity provider identifier claim field // Default: "email"
 *         requires_local_user?: bool, // A local account must exists for each OpenID user. // Default: "true"
 *         scopes?: list<scalar|null>,
 *         granted_roles?: list<scalar|null>,
 *     },
 *     csv_encoder_options?: array{ // https://symfony.com/doc/6.4/serializer/encoders.html#the-csvencoder
 *         csv_delimiter?: scalar|null, // Default: ","
 *         csv_enclosure?: scalar|null, // Default: "\""
 *         csv_escape_char?: scalar|null, // Default: ""
 *         csv_end_of_line?: scalar|null, // Default: "\n"
 *         csv_key_separator?: scalar|null, // Default: "."
 *         output_utf8_bom?: bool, // Default: false
 *     },
 *     translate_assistant?: array{
 *         deepl_api_key?: scalar|null,
 *     },
 * }
 * @psalm-type RoadizUserConfig = array{
 *     password_reset_url?: scalar|null, // Define frontend URL to redirect user to after receiving its password recovery email. **This parameter supports Symfony routes name as well as hard-coded URLs.** // Default: "loginResetPage"
 *     user_validation_url?: scalar|null, // Define frontend URL to redirect user to after receiving its email validation request. **This parameter supports Symfony routes name as well as hard-coded URLs.** // Default: "http://example.test/my-account/validate"
 *     password_reset_expires_in?: int, // Define password recovery expiring time in seconds. // Default: 600
 *     user_validation_expires_in?: int, // Define user validation token expiring time in seconds. // Default: 3600
 *     public_user_role_name?: scalar|null, // Default: "ROLE_PUBLIC_USER"
 *     passwordless_user_role_name?: scalar|null, // Default: "ROLE_PASSWORDLESS_USER"
 *     email_validated_role_name?: scalar|null, // Default: "ROLE_EMAIL_VALIDATED"
 * }
 ...
 *     default_quality?: scalar|null, // Default: 90
 *     max_pixel_size?: scalar|null, // Pixel width limit after Roadiz should create a smaller copy // Default: 2500
 *     cache_path?: scalar|null, // Default: "%kernel.project_dir%/web/assets"
 *     use_passthrough_cache?: bool, // Default: true
 *     jpegoptim_path?: scalar|null, // Default: null
 *     pngquant_path?: scalar|null, // Default: null
 *     files_path?: scalar|null, // Default: "%kernel.project_dir%/web/files"
 *     subscribers?: list<array{ // Default: []
 *         class: scalar|null,
 *         args?: list<scalar|null>,
 *     }>,
 * }
 ...
 *     default_client?: scalar|null, // Default: "default"
 *     endpoints?: array<string, array{ // Default: []
 *         scheme?: scalar|null, // Default: "http"
 *         host?: scalar|null, // Default: "127.0.0.1"
 *         port?: scalar|null, // Default: 8983
 *         path?: scalar|null, // Default: "/"
 *         core?: scalar|null,
 *     }>,
 *     clients?: array<string, array{ // Default: []
 *         client_class?: scalar|null, // Default: "Solarium\\Client"
 *         adapter_timeout?: scalar|null,
 *         adapter_service?: scalar|null,
 *         endpoints?: list<scalar|null>,
 *         default_endpoint?: scalar|null,
 *         load_balancer?: bool|array{
 *             enabled?: bool, // Default: false
 *             endpoints?: list<scalar|null>,
 *             blocked_query_types?: list<scalar|null>,
 *         },
 *         plugins?: array<string, array{ // Default: []
 *             plugin_class?: scalar|null,
 *             plugin_service?: scalar|null,
 *         }>,
 *     }>,
 * }
