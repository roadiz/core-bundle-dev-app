export default class NodeStatuses {
    constructor() {
        ...
        const containers = document.querySelectorAll('.node-statuses, .node-actions')
    ...
    init(container, items, inputs) {
        ...
        container.querySelectorAll('.rz-boolean-checkbox').forEach((checkbox) => {
    ...
    async onChange(event) {
        ...
        const response = await fetch(window.RozierConfig.routes.nodesStatusesAjax, {
            method: 'POST',
            headers: {
