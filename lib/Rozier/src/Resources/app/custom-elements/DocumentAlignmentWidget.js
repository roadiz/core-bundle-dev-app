...
export default class DocumentAlignmentWidget extends RoadizElement {
    ...
    setupOverrideHandling() {
        ...
        this.on(this.overrideButtonInput, 'change', this.onOverrideChange)
    }
    ...
    initializeElements() {
        ...
        this.on(this.resetButton, 'click', this.onResetClick)
        this.on(this.area, 'pointerdown', this.onAreaPointerDown, { passive: false })
    }
    ...
    onAreaPointerDown(event) {
        ...
        this.on(document, 'pointermove', this.onPointerMove, { passive: false })
    ...
    onPointerUp(event) {
        ...
        this.off(document, 'pointermove', this.onPointerMove)
        this.off(document, 'pointerup', this.onPointerUp)
