 ...
 *     appNamespace?: scalar|null|Param, // Default: "roadiz_app"
 *     healthCheckToken?: scalar|null|Param, // Default: null
 *     appVersion?: scalar|null|Param, // Default: "0.1.0"
 *     staticDomainName?: scalar|null|Param, // Default: null
 *     maxVersionsShowed?: scalar|null|Param, // Default: 10
 *     helpExternalUrl?: scalar|null|Param, // URL to display help button in back-office. // Default: "https://docs.roadiz.io"
 *     customPublicScheme?: scalar|null|Param, // Replace your public website URL with a dedicated domain name. It can be useful when using *headless* Roadiz version. // Default: null
 *     customPreviewScheme?: scalar|null|Param, // Replace "?_preview=1" query string to preview website content with a dedicated domain name. It can be useful when using *headless* Roadiz version. // Default: null
 *     leafletMapTileUrl?: scalar|null|Param, // Default maps tiles layout when using *Leaflet*. // Default: "https://{s}.tile.osm.org/{z}/{x}/{y}.png"
 *     mapsDefaultLocation?: scalar|null|Param, // Default maps marker location. // Default: "{\"lat\":45.766136, \"lng\":4.837326, \"zoom\":14}"
 *     previewRequiredRoleName?: scalar|null|Param, // Role name required to access preview mode. // Default: "ROLE_BACKEND_USER"
 *     defaultNodeSourceController?: scalar|null|Param, // Default: "RZ\\Roadiz\\CoreBundle\\Controller\\DefaultNodeSourceController"
 *     defaultNodeSourceControllerNamespace?: scalar|null|Param, // Default: "\\App\\Controller"
 *     webResponseClass?: scalar|null|Param, // Default: "RZ\\Roadiz\\CoreBundle\\Api\\Model\\WebResponse"
 ...
 *     customFormPostOperationName?: scalar|null|Param, // Exposed API operation name for custom-forms POST // Default: "api_custom_forms_item_post"
 *     useEmailReplyTo?: bool|Param, // Use custom-form answers email as reply-to email address when possible. // Default: true
 *     documentsLibDir?: scalar|null|Param, // Relative path to Roadiz Documents lib sources from project directory. // Default: "vendor/roadiz/documents/src"
 ...
 *     projectLogoUrl?: scalar|null|Param, // URL to display static project logo in back-office and email templates. // Default: null
 *     generatedClassNamespace?: scalar|null|Param, // Relative path to Roadiz folder for generated entity // Default: "App\\GeneratedEntity"
 *     generatedRepositoryNamespace?: scalar|null|Param, // Relative path to Roadiz folder for generated entity repositories // Default: "App\\GeneratedEntity\\Repository"
 ...
 *         timeout?: scalar|null|Param, // Default: 3
 ...
 *             port?: scalar|null|Param, // Default: 8983
 *             path?: scalar|null|Param, // Default: "/"
 *         }>,
 *     },
 *     inheritance?: array{
 *         type?: scalar|null|Param, // Doctrine inheritance strategy for creating NodesSources classes table(s). BE CAREFUL, if you change this setting after filling content in your website, all node-sources data will be lost. // Default: "single_table"
 *     },
 *     reverseProxyCache?: array{
 *         frontend?: array<string, array{ // Default: []
 *             host: scalar|null|Param, // Default: "localhost"
 *             domainName: scalar|null|Param, // Default: "localhost"
 *             timeout?: scalar|null|Param, // Default: 3
 *         }>,
 *         cloudflare?: array{
 *             version?: scalar|null|Param, // Default: "v4"
 *             zone: scalar|null|Param,
 *             bearer?: scalar|null|Param,
 *             email?: scalar|null|Param,
 ...
 *     },
 *     medias?: array{
 *         unsplash_client_id?: scalar|null|Param, // Default: null
 *         google_server_id?: scalar|null|Param, // Default: null
 *         soundcloud_client_id?: scalar|null|Param, // Default: null
 *         recaptcha_private_key?: scalar|null|Param, // Deprecated: Use roadiz_core.captcha.private_key // Default: null
 *         recaptcha_public_key?: scalar|null|Param, // Deprecated: Use roadiz_core.captcha.public_key // Default: null
 *         recaptcha_verify_url?: scalar|null|Param, // Deprecated: Use roadiz_core.captcha.verify_url // Default: "https://www.google.com/recaptcha/api/siteverify"
 *         ffmpeg_path?: scalar|null|Param, // Default: null
 *     },
 *     captcha?: array{
 *         private_key?: scalar|null|Param, // Default: null
 *         public_key?: scalar|null|Param, // Default: null
 *         verify_url?: scalar|null|Param, // Default: "https://www.google.com/recaptcha/api/siteverify"
 *     },
 * }
 * @psalm-type RoadizRozierConfig = array{
 *     node_form?: scalar|null|Param, // Default: "RZ\\Roadiz\\RozierBundle\\Form\\NodeType"
 *     theme_dir?: scalar|null|Param, // Deprecated: The "theme_dir" configuration option is deprecated and will be removed in 3.0.0. // Relative path to Rozier theme sources from project directory. // Default: "vendor/roadiz/rozier/src"
 *     manifest_path?: scalar|null|Param, // Relative path to Rozier theme manifest.json. // Default: "public/bundles/roadizrozier/manifest.json"
 *     add_node_form?: scalar|null|Param, // Default: "RZ\\Roadiz\\RozierBundle\\Form\\Node\\AddNodeType"
 ...
 *         discovery_url?: scalar|null|Param, // Standard OpenID autodiscovery URL, required to enable OpenId login in Roadiz CMS. // Default: ""
 *         hosted_domain?: scalar|null|Param, // For public identity providers (such as Google), restrict users emails by their domain. // Default: null
 *         oauth_client_id?: scalar|null|Param, // OpenID identity provider OAuth2 client ID // Default: null
 *         oauth_client_secret?: scalar|null|Param, // OpenID identity provider OAuth2 client secret // Default: null
 *         openid_username_claim?: scalar|null|Param, // OpenID identity provider identifier claim field // Default: "email"
 ...
 *         granted_roles?: list<scalar|null|Param>,
 *     },
 *     csv_encoder_options?: array{ // https://symfony.com/doc/6.4/serializer/encoders.html#the-csvencoder
 *         csv_delimiter?: scalar|null|Param, // Default: ","
 *         csv_enclosure?: scalar|null|Param, // Default: "\""
 *         csv_escape_char?: scalar|null|Param, // Default: ""
 *         csv_end_of_line?: scalar|null|Param, // Default: "\n"
 *         csv_key_separator?: scalar|null|Param, // Default: "."
 *         output_utf8_bom?: bool|Param, // Default: false
 *     },
 *     translate_assistant?: array{
 *         deepl_api_key?: scalar|null|Param,
 *     },
 * }
 * @psalm-type RoadizUserConfig = array{
 *     password_reset_url?: scalar|null|Param, // Define frontend URL to redirect user to after receiving its password recovery email. **This parameter supports Symfony routes name as well as hard-coded URLs.** // Default: "loginResetPage"
 *     user_validation_url?: scalar|null|Param, // Define frontend URL to redirect user to after receiving its email validation request. **This parameter supports Symfony routes name as well as hard-coded URLs.** // Default: "http://example.test/my-account/validate"
 ...
 *     public_user_role_name?: scalar|null|Param, // Default: "ROLE_PUBLIC_USER"
 *     passwordless_user_role_name?: scalar|null|Param, // Default: "ROLE_PASSWORDLESS_USER"
 *     email_validated_role_name?: scalar|null|Param, // Default: "ROLE_EMAIL_VALIDATED"
 * }
 * @psalm-type RoadizSolrConfig = array{
 *     search?: array{
 *         fuzzy_proximity?: int|Param, // Default: 2
 *         fuzzy_min_term_length?: int|Param, // Default: 3
 *     },
 * }
 ...
 *     default_quality?: scalar|null|Param, // Default: 90
 *     max_pixel_size?: scalar|null|Param, // Pixel width limit after Roadiz should create a smaller copy // Default: 2500
 *     cache_path?: scalar|null|Param, // Default: "%kernel.project_dir%/web/assets"
 *     use_passthrough_cache?: bool|Param, // Default: true
 *     jpegoptim_path?: scalar|null|Param, // Default: null
 *     pngquant_path?: scalar|null|Param, // Default: null
 *     files_path?: scalar|null|Param, // Default: "%kernel.project_dir%/web/files"
 ...
 *     default_client?: scalar|null|Param, // Default: "default"
 *     endpoints?: array<string, array{ // Default: []
 *         scheme?: scalar|null|Param, // Default: "http"
 *         host?: scalar|null|Param, // Default: "127.0.0.1"
 *         port?: scalar|null|Param, // Default: 8983
 *         path?: scalar|null|Param, // Default: "/"
 *         core?: scalar|null|Param,
 *     }>,
 *     clients?: array<string, array{ // Default: []
 *         client_class?: scalar|null|Param, // Default: "Solarium\\Client"
 *         adapter_timeout?: scalar|null|Param,
 *         adapter_service?: scalar|null|Param,
 *         endpoints?: list<scalar|null|Param>,
 *         default_endpoint?: scalar|null|Param,
 *         load_balancer?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             endpoints?: list<scalar|null|Param>,
 *             blocked_query_types?: list<scalar|null|Param>,
 *         },
 *         plugins?: array<string, array{ // Default: []
 *             plugin_class?: scalar|null|Param,
 *             plugin_service?: scalar|null|Param,
 *         }>,
 *     }>,
 * }
