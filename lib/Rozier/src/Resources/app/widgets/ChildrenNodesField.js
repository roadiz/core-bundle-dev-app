...
export default class ChildrenNodesField {
    constructor() {
        ...
        this.fields = document.querySelector('[data-children-nodes-widget]')
        if (!this.fields) {
            return
        }
        this.nodeTrees = this.fields.querySelectorAll('.nodetree-widget')
        this.quickAddNodeButtons = this.fields.querySelectorAll('.children-nodes-quick-creation a')

        this.cleanNodeTree()
    }

    unbind() {
        if (this.quickAddNodeButtons) {
    ...
    cleanNodeTree() {
        ...
        this.fields.querySelector('.nodetree-langs').remove()
