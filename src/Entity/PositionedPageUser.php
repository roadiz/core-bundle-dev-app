...
/**
 * @ORM\Entity()
 * @ORM\Table(name="positioned_page_user", indexes={
 *     @ORM\Index(name="ppu_position", columns={"position"}),
 *     @ORM\Index(name="ppu_node_source_id_position", columns={"node_source_id", "position"}),
 * })
 */
