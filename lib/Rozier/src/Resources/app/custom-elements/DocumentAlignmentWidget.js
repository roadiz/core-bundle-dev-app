...
export default class DocumentAlignmentWidget extends HTMLElement {
    ...
    setupOverrideHandling() {
        if (!this.overridableHotspot || !this.overrideButton) return
    ...
    dragHandle(event) {
        ...
        const { startX, startY, startWidth, startHeight, handleIndex } = this.handleDragProps
    ...
    startHotspotDrag() {
        ...
        this.hotspot?.classList.add(DocumentAlignmentWidget.CSS_CLASSES.GRABBING)
    ...
    stopHotspotDrag() {
        this.isDraggingHotspot = false
        this.hotspot?.classList.remove(DocumentAlignmentWidget.CSS_CLASSES.GRABBING)
    }
    ...
    startAreaDrag(event) {
        ...
        this.area.classList.add(DocumentAlignmentWidget.CSS_CLASSES.DRAGGING)
    ...
    stopAreaDrag() {
        this.isDraggingArea = false
        this.area.classList.remove(DocumentAlignmentWidget.CSS_CLASSES.DRAGGING)
    }
    ...
    onPointerUp(event) {
        ...
        if (this.isDraggingHandle) this.stopHandleDrag()
