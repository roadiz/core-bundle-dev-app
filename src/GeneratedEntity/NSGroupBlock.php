...
#[
    ...
    ORM\Entity(repositoryClass: \App\GeneratedEntity\Repository\NSGroupBlockRepository::class),
    ORM\Table(name: "ns_groupblock"),
    ApiFilter(PropertyFilter::class)
]
class NSGroupBlock extends \RZ\Roadiz\CoreBundle\Entity\NodesSources
{
    #[
