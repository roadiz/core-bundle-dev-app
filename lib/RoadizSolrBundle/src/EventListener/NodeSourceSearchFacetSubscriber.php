...
final class NodeSourceSearchFacetSubscriber implements EventSubscriberInterface
{
    public function onQuery(NodeSourceSearchQueryEvent $event): void
    {
        ...
        $facetSet->createJsonFacetTerms(['local_key' => 'node_type', 'field' => 'node_type_s', 'domain' => ['excludeTags' => 'node_type']]);
        $facetSet->createJsonFacetTerms(['local_key' => 'document_type', 'field' => 'document_type_s', 'domain' => ['excludeTags' => 'document_type']]);
        $facetSet->createJsonFacetTerms(['local_key' => 'tag_name', 'field' => 'facet_tags_ss', 'domain' => ['excludeTags' => 'tag_name']]);
    }
