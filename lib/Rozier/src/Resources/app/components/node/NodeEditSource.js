    ...
    init() {
        ...
        this.devNames.forEach((devName) => {
            if (devName.getAttribute('data-dev-name') !== '') {
                ...
                if (label) {
                    label.insertAdjacentHTML('beforeend', '<span class="field-dev-name">' + devName.getAttribute('data-dev-name') + '</span>')
                } else if (barLabel) {
                    barLabel.insertAdjacentHTML('beforeend', '<span class="field-dev-name">' + devName.getAttribute('data-dev-name') + '</span>')
                }
            }
        })
