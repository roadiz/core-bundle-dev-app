    ...
    loadTemplate() {
        ...
        return fetch(templatePath).then(async (response) => {
            ...
            if (widget) {
                ...
                widget.setAttribute('origin-button-id', this.getAttribute('origin-button-id'))
                widget.setAttribute('overridable-hotspot', true)

                const originalHotspot = this.getAttribute('original-hotspot')

                if (originalHotspot) {
                    widget.setAttribute('original-hotspot', this.getAttribute('original-hotspot'))
                }
            }
