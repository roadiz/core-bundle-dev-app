...
- **Cercle** ![Capture d’écran 2022-02-25 à 16.04.12.webp](edition_des_contenus/Capture_decran_2022-02-25_a_16.04.12.webp)
    ...
    Le cercle indique que le contenu est publié et visible publiquement par les utilisateurs du site.

- **Losange** ![Capture d’écran 2022-02-25 à 16.01.24.webp](edition_des_contenus/Capture_decran_2022-02-25_a_16.01.24.webp)
    
    Le losange indique que le nœud est **en brouillon** (visible par les administrateurs du CMS en prévisualisation uniquement). **URL désactivée**.
...
Pour connaître le type de bloc sur une page, survolez le cercle ou le losange avec votre souris :
