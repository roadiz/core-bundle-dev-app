...
export function getTags({ searchTerms, filters, filterExplorerSelection, moreData }) {
    ...
    return fetch(window.RozierRoot.routes.tagsAjaxExplorerList + '?' + new URLSearchParams(postData), {
        method: 'GET',
        headers: {
...
export function getTagsByIds({ ids = [] }) {
    ...
    return fetch(window.RozierRoot.routes.tagsAjaxByArray + '?' + new URLSearchParams(postData), {
        method: 'GET',
        headers: {
            Accept: 'application/json',
        },
...
export function createTag({ tagName }) {
    ...
    return fetch(window.RozierRoot.routes.tagsAjaxCreate + '?' + new URLSearchParams(postData), {
        method: 'POST',
        headers: {
            Accept: 'application/json',
        },
