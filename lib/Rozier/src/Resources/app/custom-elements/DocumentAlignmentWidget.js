    ...
    init() {
        ...
        const onMouseMove = (e) => {
            ...
            if (this.imageWrapper) {
                ...
                const normLeft = newLeft / wrapperRect.width
                const normTop = newTop / wrapperRect.height
                const normWidth = newWidth / wrapperRect.width
                const normHeight = newHeight / wrapperRect.height
        ...
        const updateArea = ({ areaStartX, areaStartY, areaEndX, areaEndY }) => {
            const wrapperRect = this.imageWrapper.getBoundingClientRect()
