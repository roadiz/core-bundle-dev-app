...
import iconifyCollectionPlugin from './vite-plugins/iconify/iconify-collections'
import availableRemixIcons from './vite-plugins/iconify/ri-icons'
    ...
    return {
        ...
        plugins: [
            ...
            iconifyCollectionPlugin([
                ...
                outputDir: 'app/assets/css/vendors/iconify',
            }),
        ],
    }
})
