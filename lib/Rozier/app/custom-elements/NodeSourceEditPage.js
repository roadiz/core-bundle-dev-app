    ...
    wrapInTabs() {
        ...
        if (fieldsGroupsLength > 1) {
            this.form.insertAdjacentHTML(
                'beforeend',
                '<rz-tablist class="rz-tablist" role="tablist" id="node-source-form-switcher-nav">' +
                    '</rz-tablist>' +
            ...
            for (let index in fieldGroups) {
                ...
                if (fieldGroup.id === 'default') {
                    formSwitcherNav.insertAdjacentHTML(
                        ...
                        '<button id="' +
                            tabId +
                            '" role="tab" class="rz-tablist__item rz-tablist__item--selected" type="button" aria-controls="' +
                            groupId +
                            '">Main</button>',
                    )
                } else {
                    formSwitcherNav.insertAdjacentHTML(
                        ...
                        '<button id="' +
                            tabId +
                            '" role="tab" class="rz-tablist__item rz-tablist__item" type="button" aria-controls="' +
                            groupId +
                            '">' +
                            fieldGroup.name +
                            '</button>',
        ...
        this.activateTabNav(this.form.querySelector('.rz-tablist__item'))

        this.form.querySelectorAll('.rz-tablist__item').forEach((button) => {
            button.addEventListener('click', () => {
                const tabId = button.getAttribute('aria-controls')

                this.form
                    .querySelectorAll('.rz-tablist__item')
                    .forEach((item) => this.desactivateTabNav(item))
                this.activateTabNav(button.closest('.rz-tablist__item'))
