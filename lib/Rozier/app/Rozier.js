...
export default class Rozier {
    ...
    async refreshMainNodeTree(translationId = undefined) {
        this.refreshAsideMainTree(window.RozierConfig.routes.nodesTreeAjax, {
            translationId: translationId,
        })
    }

    async refreshMainTagTree(translationId = undefined) {
        this.refreshAsideMainTree(window.RozierConfig.routes.tagsTreeAjax, {
            translationId: translationId,
        })
    }

    async refreshMainFolderTree(translationId = undefined) {
        this.refreshAsideMainTree(window.RozierConfig.routes.foldersTreeAjax, {
            translationId: translationId,
        })
    }
