...
import iconifyCollectionPlugin from './vite-plugins/iconify-collections'
...
export default defineConfig(({ mode }) => {
    return {
        ...
        plugins: [
            vue(),
            devManifest(),
            iconifyCollectionPlugin([
                {
                    prefix: 'mdi',
                    outputDir: 'app/assets/vendors/iconify',
                    outputName: 'mdi-icon-collection'
                },
                {
                    prefix: 'ri',
                    outputDir: 'app/assets/vendors/iconify',
                    outputName: 'ri-icon-collection'
                },
                {
                    prefix: 'rz',
                    srcDir: 'app/assets/img/rz-icons',
                    outputDir: 'app/assets/vendors/iconify',
                    outputName: 'rz-icon-collection'
            }
            ]),
        ],
    }
