...
/**
 * Get items for the Explorer panel. Depending on its entity type (document, node...).
 *
 * @param {String} entity
...
export function getExplorerItems({
    ...
    switch (entity) {
        ...
        case NODE_TYPE_ENTITY:
            return NodeTypeApi.getNodeTypes({
                searchTerms,
                preFilters,
                filters,
                filterExplorerSelection,
        ...
        case CUSTOM_FORM_ENTITY:
            return CustomFormApi.getCustomForms({
                searchTerms,
                preFilters,
                filters,
                filterExplorerSelection,
        ...
        case EXPLORER_PROVIDER_ENTITY:
            return ExplorerProviderApi.getItems({
                searchTerms,
                preFilters,
                filters,
                filterExplorerSelection,
