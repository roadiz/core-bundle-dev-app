...
export default class Rozier {
    ...
    resize() {
        ...
        // if (this.mainTreesContainer && this.mainContentScrollable) {
        //     if (this.windowWidth >= 768) {
        //         this.mainContentScrollable.style.height = this.windowHeight
        //         this.mainTreesContainer.style.height = ''
        //     } else {
        //         this.mainContentScrollable.style.height = ''
        //         this.mainTreesContainer.style.height = this.windowHeight
        //     }
        // }

        // Tree scroll height
        // if (this.mainTrees) {
        //     this.$nodeTreeHead = this.mainTrees.querySelectorAll('.nodetree-head')
        //     this.$treeScrollCont = this.mainTrees.querySelectorAll('.tree-scroll-cont')
        //     this.$treeScroll = this.mainTrees.querySelectorAll('.tree-scroll')
        //
        //     /*
        //      * need actual to get tree height even when they are hidden.
        //      */
        //     // TODO: We need size for calculate tree scroll height. but with css we can do it now.
        //     this.nodesSourcesSearchHeight = window.getComputedStyle(this.nodesSourcesSearch).getPropertyValue('height')
        //     this.nodeTreeHeadHeight = this.$nodeTreeHead.offsetHeight
        ...
        // Main content
        // this.mainContentScrollableWidth = this.mainContentScrollable.style.width
