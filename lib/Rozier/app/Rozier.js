...
export default class Rozier {
    ...
    bindMainTreeLangSwitcher() {
        this.bindLangButtonClicked('.nodetree-langs', (translationId) => {
            this.refreshMainNodeTree(translationId)
        })

        this.bindLangButtonClicked('.foldertree-langs', (translationId) => {
            this.refreshMainFolderTree(translationId)
        })

        this.bindLangButtonClicked('.tagtree-langs', (translationId) => {
