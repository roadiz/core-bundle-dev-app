...
import DocumentAlignmentWidget from './custom-elements/DocumentAlignmentWidget'
import DocumentEditDialog from './custom-elements/DocumentEditDialog'
...
ready(() => {
    ...
    ; (function () {
        ...
        customElements.define('document-alignment-widget', DocumentAlignmentWidget)
        customElements.define('document-edit-dialog', DocumentEditDialog)
