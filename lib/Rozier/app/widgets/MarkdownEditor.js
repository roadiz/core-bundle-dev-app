...
export default class MarkdownEditor {
    ...
    constructor(textarea, index) {
        ...
        this.buttonTranslateAssistantClick = this.buttonTranslateAssistantClick.bind(this)
        this.buttonTranslateAssistantRephraseClick = this.buttonTranslateAssistantRephraseClick.bind(this)
    ...
    init() {
        ...
        this.buttonTranslateAssistant = this.cont.querySelectorAll('.markdown-editor-button-translate-assistant-translate')
        this.buttonTranslateAssistantRephrase = this.cont.querySelectorAll('.markdown-editor-button-translate-assistant-rephrase')
        ...
        this.buttonTranslateAssistantRephrase.forEach((button) => {
            button.addEventListener('click', this.buttonTranslateAssistantRephraseClick)
        })
    ...
    async buttonTranslateAssistantClick(e) {
        ...
        const response = await fetch(window.RozierConfig.routes.translateAssistantTranslate, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
            },
    ...
    async buttonTranslateAssistantRephraseClick(e) {
        ...
        const response = await fetch(window.RozierConfig.routes.translateAssistantRephrase, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
            },
