export default class RzSaveButton extends HTMLButtonElement {
    ...
    connectedCallback() {
        this.actionMenu = document.querySelector('.rz-actions-menu')
        ...
        if (this.actionMenu !== this.parentElement) {
            ...
            this.actionMenu.insertBefore(this, this.actionMenu.lastChild)
            const label = this.querySelector('.rz-button__label')
