...
- **(auth)** do not log user login if token is JWTPostAuthenticationToken - ([20c2793](https://github.com/roadiz/core-bundle-dev-app/commit/20c2793))
- update return type annotation for getValueType - ([8b58a79](https://github.com/roadiz/core-bundle-dev-app/commit/8b58a79))
- **(impersonation)** url encode username in admin link - ([dcd9221](https://github.com/roadiz/core-bundle-dev-app/commit/dcd9221))
- **(migrations)** fixed missing DB indexes drop in existing migrations - ([669f65d](https://github.com/roadiz/core-bundle-dev-app/commit/669f65d))
- update condition for normalizing document explorer_thumbnail - ([913fdb6](https://github.com/roadiz/core-bundle-dev-app/commit/913fdb6))
- **(ui)** prevent duplicate webp source in DrawerItem - ([7056fe2](https://github.com/roadiz/core-bundle-dev-app/commit/7056fe2))
- undo media query update in .less file ([#245](https://github.com/roadiz/core-bundle-dev-app/issues/245)) - ([3b9335d](https://github.com/roadiz/core-bundle-dev-app/commit/3b9335d))
- update import path - ([524ff24](https://github.com/roadiz/core-bundle-dev-app/commit/524ff24))
- **(iconify)** rz collection format - ([dd87a67](https://github.com/roadiz/core-bundle-dev-app/commit/dd87a67))
- **(iconify)** rz collection format - ([38b60a6](https://github.com/roadiz/core-bundle-dev-app/commit/38b60a6))
- add polyfill for Safari - ([471edeb](https://github.com/roadiz/core-bundle-dev-app/commit/471edeb))
- **(CacheController)** update autowire attribute syntax for cache clearer service - ([7eac724](https://github.com/roadiz/core-bundle-dev-app/commit/7eac724))
- **(editorconfig)** update indentation rules for Rozier files - ([02b5b2a](https://github.com/roadiz/core-bundle-dev-app/commit/02b5b2a))
- **(vite)** config regression - ([d6179f0](https://github.com/roadiz/core-bundle-dev-app/commit/d6179f0))
- **(iconify)** output file format - ([0f9b301](https://github.com/roadiz/core-bundle-dev-app/commit/0f9b301))
- **(NodeTreeContextualMenu)** use try/catch for postNodeUpdate() - ([84bce86](https://github.com/roadiz/core-bundle-dev-app/commit/84bce86))
- **(NodeTreeContextualMenu)** ensure loader is always hidden even if error occurs - ([a31cd35](https://github.com/roadiz/core-bundle-dev-app/commit/a31cd35))
- **(StackNodeTree)** use try/catch block for refreshNodeTree() - ([c536cc7](https://github.com/roadiz/core-bundle-dev-app/commit/c536cc7))
- TS errors - ([3f1cd9d](https://github.com/roadiz/core-bundle-dev-app/commit/3f1cd9d))
- remove unused vars - ([0473a41](https://github.com/roadiz/core-bundle-dev-app/commit/0473a41))
- **(ChildrenNodesField)** TS error - ([db5c093](https://github.com/roadiz/core-bundle-dev-app/commit/db5c093))
- **(ChildrenNodesField)** do not use Promise async executor - ([6b85388](https://github.com/roadiz/core-bundle-dev-app/commit/6b85388))
- update @assets alias - ([30b12fa](https://github.com/roadiz/core-bundle-dev-app/commit/30b12fa))
- Change outDir vite build and rebuild - ([d574d61](https://github.com/roadiz/core-bundle-dev-app/commit/d574d61))
- **(Rozier)** Vue initialization with custom elements ([#175](https://github.com/roadiz/core-bundle-dev-app/issues/175)) - ([41dbf43](https://github.com/roadiz/core-bundle-dev-app/commit/41dbf43))
- **(hotspot)** add size attributes to image - ([0a19019](https://github.com/roadiz/core-bundle-dev-app/commit/0a19019))
- **(hotspot)** preview opened behind the hotspot modal - ([775d3a3](https://github.com/roadiz/core-bundle-dev-app/commit/775d3a3))

### Documentation

- add documentation for optional Roadiz bundles ([#329](https://github.com/roadiz/core-bundle-dev-app/issues/329)) - ([4600c4a](https://github.com/roadiz/core-bundle-dev-app/commit/4600c4a))
- update AGENTS.md with project and contribution guidelines - ([d79d40b](https://github.com/roadiz/core-bundle-dev-app/commit/d79d40b))
- add project overview and folder structure to AGENTS.md - #227 ([#236](https://github.com/roadiz/core-bundle-dev-app/issues/236)) - ([0381fc1](https://github.com/roadiz/core-bundle-dev-app/commit/0381fc1))

### Features

- **(nodes_sources)** add isPublished method for serialization - ([5572359](https://github.com/roadiz/core-bundle-dev-app/commit/5572359))
- Add webhook system for CustomForms to dispatch data to external CRM systems ([#308](https://github.com/roadiz/core-bundle-dev-app/issues/308)) - ([37e5702](https://github.com/roadiz/core-bundle-dev-app/commit/37e5702))
- **(ui)** add rz-dashboard, row and panel css components - ([462023f](https://github.com/roadiz/core-bundle-dev-app/commit/462023f))
- **(ui)** update dashboard layout to make it extendable - ([aeb6901](https://github.com/roadiz/core-bundle-dev-app/commit/aeb6901))
- add node copy and paste feature ([#303](https://github.com/roadiz/core-bundle-dev-app/issues/303)) - ([9be1242](https://github.com/roadiz/core-bundle-dev-app/commit/9be1242))
- replace hard-coded public and preview nodes-sources URL with proxy redirection - ([76c0d61](https://github.com/roadiz/core-bundle-dev-app/commit/76c0d61))
- **(routes)** migrate tags YAML routes to and add new routes attribute - ([c496e01](https://github.com/roadiz/core-bundle-dev-app/commit/c496e01))
- **(routes)** migrate ajax YAML routes to and add new routes attribute - ([c1fb7a1](https://github.com/roadiz/core-bundle-dev-app/commit/c1fb7a1))
- **(routes)** migrate YAML routes to and add new routes attribute - ([ec3ffda](https://github.com/roadiz/core-bundle-dev-app/commit/ec3ffda))
- **(user)** add UserUsernameChangedEvent and dispatch on username change - ([c994f4e](https://github.com/roadiz/core-bundle-dev-app/commit/c994f4e))
- improve importing embed document using only URL field ([#272](https://github.com/roadiz/core-bundle-dev-app/issues/272)) - ([190c7dc](https://github.com/roadiz/core-bundle-dev-app/commit/190c7dc))
- **(rozier)** add EntityThumbnail custom element with async API endpoint ([#277](https://github.com/roadiz/core-bundle-dev-app/issues/277)) - ([1165325](https://github.com/roadiz/core-bundle-dev-app/commit/1165325))
- generate iconify collection and update icon.story ([#264](https://github.com/roadiz/core-bundle-dev-app/issues/264)) - ([95c2644](https://github.com/roadiz/core-bundle-dev-app/commit/95c2644))
- setup fieldset style and stories - ([82678ba](https://github.com/roadiz/core-bundle-dev-app/commit/82678ba))
- add rzMessage and RzFormField - ([7855a4c](https://github.com/roadiz/core-bundle-dev-app/commit/7855a4c))
- **(ts)** add all the directories processed by Vite to the TS config - ([a88645f](https://github.com/roadiz/core-bundle-dev-app/commit/a88645f))
- **(storybook)** init lazy custom elements - ([bc8023a](https://github.com/roadiz/core-bundle-dev-app/commit/bc8023a))
- remove global style - ([0f90c87](https://github.com/roadiz/core-bundle-dev-app/commit/0f90c87))
- add theme style logic ([#238](https://github.com/roadiz/core-bundle-dev-app/issues/238)) - ([a395551](https://github.com/roadiz/core-bundle-dev-app/commit/a395551))
- add rz-workspace-item story and style - ([ad29f9a](https://github.com/roadiz/core-bundle-dev-app/commit/ad29f9a))
- setup postcss-pxtorem - ([21a511d](https://github.com/roadiz/core-bundle-dev-app/commit/21a511d))
- add text css files and storie - ([83f829d](https://github.com/roadiz/core-bundle-dev-app/commit/83f829d))
- introduce `projectLogoUrl` configuration to replace admin image usage ([#234](https://github.com/roadiz/core-bundle-dev-app/issues/234)) - ([2eaa412](https://github.com/roadiz/core-bundle-dev-app/commit/2eaa412))
- **(rozier)** add bookmarks section to admin menu and dashboard, fixed admin menu JS mobile events - ([86633df](https://github.com/roadiz/core-bundle-dev-app/commit/86633df))
- use DropzoneOptions interface - ([3afd625](https://github.com/roadiz/core-bundle-dev-app/commit/3afd625))
- add RzFileUpload component - ([639f49a](https://github.com/roadiz/core-bundle-dev-app/commit/639f49a))
- setup prettier - ([6af5718](https://github.com/roadiz/core-bundle-dev-app/commit/6af5718))
- lazy load custom built-in elements - ([1ce3d39](https://github.com/roadiz/core-bundle-dev-app/commit/1ce3d39))
- replace standard save buttons with RzSaveButton customized built-in element - ([9fb7e69](https://github.com/roadiz/core-bundle-dev-app/commit/9fb7e69))
- convert ColorInput to custom-element - ([002068d](https://github.com/roadiz/core-bundle-dev-app/commit/002068d))
- init rz-button style - ([8cc77fa](https://github.com/roadiz/core-bundle-dev-app/commit/8cc77fa))
- add Colors story - ([21f7807](https://github.com/roadiz/core-bundle-dev-app/commit/21f7807))
- add eslint stylistic - ([ce971f8](https://github.com/roadiz/core-bundle-dev-app/commit/ce971f8))
- add back-office bookmarks configurable links ([#201](https://github.com/roadiz/core-bundle-dev-app/issues/201)) - ([377f376](https://github.com/roadiz/core-bundle-dev-app/commit/377f376))
- add vite-plugin-iconify-collection - ([d99e645](https://github.com/roadiz/core-bundle-dev-app/commit/d99e645))
- add RZIcon component and setup custom iconify collection - ([3504ab3](https://github.com/roadiz/core-bundle-dev-app/commit/3504ab3))
- add new shadow nodes and AbstractSingleNodeTypeController helper to build custom back-office entries ([#192](https://github.com/roadiz/core-bundle-dev-app/issues/192)) - ([f1e6bdb](https://github.com/roadiz/core-bundle-dev-app/commit/f1e6bdb))
- upgrade to eslint v9 and add config - ([2b7a592](https://github.com/roadiz/core-bundle-dev-app/commit/2b7a592))
- add Storybook - ([6632eaf](https://github.com/roadiz/core-bundle-dev-app/commit/6632eaf))
- add Deepl translator to markdown fields ([#185](https://github.com/roadiz/core-bundle-dev-app/issues/185)) - ([e659ea1](https://github.com/roadiz/core-bundle-dev-app/commit/e659ea1))
- implement RFC 7807 compliant error responses for contact-forms and custom-forms ([#186](https://github.com/roadiz/core-bundle-dev-app/issues/186)) - ([3016f1c](https://github.com/roadiz/core-bundle-dev-app/commit/3016f1c))
- **(rozier)** add base custom element - ([fdedd1c](https://github.com/roadiz/core-bundle-dev-app/commit/fdedd1c))
- **(rozier)** use lazy custom elements - ([1a135b2](https://github.com/roadiz/core-bundle-dev-app/commit/1a135b2))

### Styling

- **(ui)** replace border-radius with clip-path for node images - ([227ed42](https://github.com/roadiz/core-bundle-dev-app/commit/227ed42))
- simplify element inside fieldset and update style - ([b31e126](https://github.com/roadiz/core-bundle-dev-app/commit/b31e126))
- add color modifier in rzButton - ([72753f4](https://github.com/roadiz/core-bundle-dev-app/commit/72753f4))
- add border radius variant - ([f6e1d9e](https://github.com/roadiz/core-bundle-dev-app/commit/f6e1d9e))
- update story layout - ([0257c3a](https://github.com/roadiz/core-bundle-dev-app/commit/0257c3a))
- update theme var value - ([d47c260](https://github.com/roadiz/core-bundle-dev-app/commit/d47c260))
- fix nested selector - ([16e219e](https://github.com/roadiz/core-bundle-dev-app/commit/16e219e))
- add on--dark style - ([646c578](https://github.com/roadiz/core-bundle-dev-app/commit/646c578))
- set cursor pointer by default - ([21fdfcc](https://github.com/roadiz/core-bundle-dev-app/commit/21fdfcc))
- add rz-workspace-item.css file - ([b7b2d92](https://github.com/roadiz/core-bundle-dev-app/commit/b7b2d92))
- fix css var name - ([1c9162e](https://github.com/roadiz/core-bundle-dev-app/commit/1c9162e))
- add font-family fallback - ([34b362d](https://github.com/roadiz/core-bundle-dev-app/commit/34b362d))
- **(upload)** fix border property duplication - ([7793f0d](https://github.com/roadiz/core-bundle-dev-app/commit/7793f0d))
- **(preview)** fix border property duplication - ([e0c2630](https://github.com/roadiz/core-bundle-dev-app/commit/e0c2630))
- apply old style with new css workflow - ([c22fd47](https://github.com/roadiz/core-bundle-dev-app/commit/c22fd47))
- add common style for storybook - ([07c133b](https://github.com/roadiz/core-bundle-dev-app/commit/07c133b))
- remove responsive style for default rz-button class - ([2c8ff19](https://github.com/roadiz/core-bundle-dev-app/commit/2c8ff19))
- remove responsive sizes - ([d6b20ec](https://github.com/roadiz/core-bundle-dev-app/commit/d6b20ec))
- simplify and remove duplicated style - ([1efacaf](https://github.com/roadiz/core-bundle-dev-app/commit/1efacaf))
- use css color instead explicit value - ([343a38c](https://github.com/roadiz/core-bundle-dev-app/commit/343a38c))
- improve default rz-button style - ([664233a](https://github.com/roadiz/core-bundle-dev-app/commit/664233a))
- update stories and add breakpoint style - ([1f9c03b](https://github.com/roadiz/core-bundle-dev-app/commit/1f9c03b))
- adapt to icon usage - ([ee85603](https://github.com/roadiz/core-bundle-dev-app/commit/ee85603))
- init story - ([0dd3d08](https://github.com/roadiz/core-bundle-dev-app/commit/0dd3d08))
- **(hotspot)** improve image responsive sizing ([#167](https://github.com/roadiz/core-bundle-dev-app/issues/167)) - ([dc212d8](https://github.com/roadiz/core-bundle-dev-app/commit/dc212d8))

### Performance

- use only specific iconify json module instead build all collections - ([bf940c1](https://github.com/roadiz/core-bundle-dev-app/commit/bf940c1))
