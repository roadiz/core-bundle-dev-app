...
export default class LeafletGeotagField {
    ...
    createIcon() {
        return new Icon({
            iconUrl: window.RozierConfig.resourcesUrl + 'assets/img/marker.png',
            iconRetinaUrl: window.RozierConfig.resourcesUrl + 'assets/img/marker@2x.png',
            shadowUrl: window.RozierConfig.resourcesUrl + 'assets/img/marker_shadow.png',
            shadowRetinaUrl: window.RozierConfig.resourcesUrl + 'assets/img/marker_shadow@2x.png',
